...
class _Get_CategoriesState extends State<Get_Categories> {
  ...
  List<Category> all_category = [
    Category("Macanique", "assets/img/mecanique.png"),
    Category("Coding", "assets/img/prog.png"),
    Category("Electronique", "assets/img/electrique.png"),
    Category("Agriculture", "assets/img/agr.png"),
    Category("Batiment", "assets/img/batiment.png"),
